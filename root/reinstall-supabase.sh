...
SUPABASE_PASSWORD="02061994" # A senha do banco de dados que você corrigiu
SUPABASE_JWT_SECRET="segredosupersegredoparajwt123!@#" # Um segredo JWT forte, pode ser alterado
...
echo "1. Navegue para a pasta da API: cd /root/api"
echo "2. Execute o script de inicialização: ./start-project.sh"
echo "3. Verifique a conexão com o banco: node test-db-connection.js"
